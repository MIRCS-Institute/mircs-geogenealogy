  ...
  function onEachFeature(feature, layer) {
    ...
    if (feature.properties) {
      ...
      $.each(feature.keys, function(key, val){
        ...
        count++;
        left += "<font color='purple'>" + val + "</font>"+ "<br/>";
        right += feature.properties[val] +"<br/>";
      });
      popupText += "<div id ='detail'><input id ='in' class='ui button green' type='button' onClick= 'myFunction(left, right)' value='Detail'></div>";
